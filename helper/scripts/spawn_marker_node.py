...
class TargetMarker:
    ...
    def __init__(self):
        self.__marker_pub       = rospy.Publisher('targetMarker', Marker, queue_size=10)
        self.__targetMarker     = Marker()
        self.__pose_sub         = rospy.Subscriber("/move_base_simple/goal", PoseStamped, self.__setMarker__)
